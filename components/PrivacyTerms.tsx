...
export default function PrivacyTerms(props: PrivacyTermsProps) {
  const lastUpdatedLabel = props.lastUpdatedLabel;
  const contactTitle = props.contactTitle;
  const contactText = props.contactText;
  const contactAddressLabel = props.contactAddressLabel;
  const contactRightsText = props.contactRightsText;
  ...
  return (
    <section className="my-16 mx-4 sm:mx-8 md:mx-16 lg:mx-24 max-w-4xl lg:max-w-5xl">
      ...
      <p className="text-gray-600 dark:text-gray-300 mb-8 font-light">
        {lastUpdatedLabel} {props.lastUpdated}
      </p>
      ...
      <div className="space-y-8">
        ...
        {props.contactEmail && (
          <article>
            <h2 className="text-xl sm:text-2xl font-semibold dark:text-white mb-4">
              {props.sections.length + 1}. {contactTitle}
            </h2>
            <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
              {contactText}
              <br />
              ...
              <a
                ...
                className="text-emerald hover:text-logo-lime transition-colors underline"
              >
                {props.contactEmail}
              </a>
              <br />
